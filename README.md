...
1. **Passagem Automática de Páginas**: Permite configurar um intervalo de tempo para avançar automaticamente para a próxima página.

2. **Interface Intuitiva**: Apresenta um menu de fácil utilização para controlar as funcionalidades do script.

3. **Detecção de Quiz**: Capaz de identificar e pausar a automação quando encontra uma atividade ou quiz.

4. **Opção de Auto-Continuar**: Possibilidade de retomar automaticamente a passagem de páginas após a conclusão de um quiz.

5. **Configurações Personalizáveis**: Permite ajustar o intervalo de tempo entre as passagens de página em segundos ou milissegundos.

6. **Notificações**: Fornece feedback visual sobre o status da execução do script.

7. **Convite para Discord**: Inclui um overlay com convite para a comunidade Discord relacionada ao script.

## Como Usar:

1. Instale um gerenciador de scripts de usuário como Tampermonkey ou Greasemonkey em seu navegador.
2. Adicione o script LeiaCheat ao seu gerenciador de scripts.
3. Acesse a plataforma de leitura compatível.
4. Use o botão "LeiaCheat" que aparecerá na interface para abrir o menu de controle.
5. Configure as opções desejadas e inicie a automação.

## Aviso Legal:

Este script é destinado apenas para fins educacionais e de pesquisa. O uso deste script deve estar em conformidade com os termos de serviço da plataforma de leitura em questão.
